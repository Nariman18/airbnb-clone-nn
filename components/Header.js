  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
        ...
        <div className="flex items-center space-x-4 justify-end text-gray-500">
          ...
          <div className="flex border-2 items-center space-x-2 p-2 radius-2 rounded-full">
        ...
        {searchInput && (
          <div className="flex flex-col col-span-3 mx-auto">
            ...
            <div className="flex items-center border-b mb-4">
              ...
              <UsersIcon className="h-5 text-red-400"/>
           ...
           <div className="flex">
            <button onClick={resetInput} className="flex-grow text-gray-500 hover:text-black  ">Cancel</button>
